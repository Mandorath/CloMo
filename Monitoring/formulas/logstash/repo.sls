...
logstash-repo:
  pkgrepo.managed:
    ...
    - name: deb http://packages.elasticsearch.org/packages/oss-{{ version }}/debian stable main
    - require:
...
logstash-repo:
  pkgrepo.managed:
    ...
    - baseurl: http://packages.elasticsearch.org/logstash/oss-{{ version }}/centos
    - gpgcheck: 1
...
logstash-repo:
    pkgrepo.{{ repo_state }}:
        ...
        - baseurl: https://artifacts.elastic.co/packages/oss-{{ version }}.x/yum
